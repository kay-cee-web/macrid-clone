...
const components: Components = {
  ...
  h2: (props) => <h3 className="mb-2 mt-4 text-[16.5px] font-semibold first:mt-0" {...props} />,
  h3: (props) => <h4 className="mb-1.5 mt-3 font-sans text-[15px] font-semibold first:mt-0" {...props} />,
  ...
  pre: (props) => (
    <pre className="my-3 overflow-x-auto rounded-[10px] border border-line bg-raised p-3 font-mono text-[13px] leading-relaxed" {...props} />
  ),
  table: (props) => (
    <div className="my-3 overflow-x-auto rounded-[10px] border border-line">
      <table className="w-full border-collapse text-left text-[13.5px] tabular-nums" {...props} />
    </div>
  ),
