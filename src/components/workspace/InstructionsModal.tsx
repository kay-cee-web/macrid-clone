      ...
      <form id="instructions-form" onSubmit={onSubmit} className="grid gap-4">
        ...
        <Field id="agent-instructions" label="Brief" hint="Plain language is fine. Markdown works too.">
          <textarea
            ...
            rows={12}
            className="w-full resize-y rounded-[10px] border border-line bg-surface px-3 py-2.5 text-base leading-relaxed text-ink outline-none transition-colors hover:border-faint sm:text-sm focus:border-accent focus:ring-3 focus:ring-accent-soft"
